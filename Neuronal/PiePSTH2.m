%% Raster, PSTH and SDF  - version 2
% This version is to be applied to recordings after 14/05/2018
% Where condition numbers were increased, thus pushing the TTL values for 
% licks, rewards etc to >50.
...
%Condition-number
SelConds            =  4; %1:32 %32 possible conditions [17 18 20 21]
...
idx_stims = find(ismember(events_ttl,[1:42 [1:32]+16384 [1:32]+32768])==1); %indexes of stims. can do with str too
%Subselect trials
if boolFilt
%modality
